...
square[5] = new Square("Subway Railroad", "$200", "#FFFFFF", 200, 1);
...
square[12] = new Square("SAS Company", "$150", "#FFFFFF", 150, 2);
...
square[15] = new Square("Chungus Railroad", "$200", "#FFFFFF", 200, 1);
...
square[25] = new Square("Mewing Railroad", "$200", "#FFFFFF", 200, 1);
...
square[35] = new Square("Zesty Line", "$200", "#FFFFFF", 200, 1);
...
square[39] = new Square("Titled Towers", "$400", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
