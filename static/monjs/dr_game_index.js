class Player {
  ...
  constructor(ctx, width, height, minJumpHeight, maxJumpHeight, scaleRatio) {
    ...
    this.standingStillImage.src = "static/dr_game_images/oi.png";
    this.image = this.standingStillImage;

    const dinoRunImage1 = new Image();
    dinoRunImage1.src = "static/dr_game_images/oi.png";

    const dinoRunImage2 = new Image();
    dinoRunImage2.src = "static/dr_game_images/oi.png";
...
class Ground {
  constructor(ctx, width, height, speed, scaleRatio) {
    ...
    this.groundImage.src = "static/dr_game_images/ground.png";
  }
...
const CACTI_CONFIG = [
  { width: 48 / 1.5, height: 100 / 1.5, image: "static/dr_game_images/cactus_1.png" },
  { width: 98 / 1.5, height: 100 / 1.5, image: "static/dr_game_images/cactus_2.png" },
  { width: 68 / 1.5, height: 70 / 1.5, image: "static/dr_game_images/cactus_3.png" },
];
